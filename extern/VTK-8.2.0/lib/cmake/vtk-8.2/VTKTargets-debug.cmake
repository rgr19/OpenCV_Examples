...
set_target_properties(vtkParallelMPI PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkParallelMPI-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkParallelMPI-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkParallelMPI )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkParallelMPI "${_IMPORT_PREFIX}/lib/libvtkParallelMPI-8.2.so.1" )
...
set_target_properties(vtkFiltersParallelFlowPaths PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkFiltersParallelFlowPaths-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkFiltersParallelFlowPaths-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkFiltersParallelFlowPaths )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkFiltersParallelFlowPaths "${_IMPORT_PREFIX}/lib/libvtkFiltersParallelFlowPaths-8.2.so.1" )
...
set_target_properties(vtkFiltersParallelMPI PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkFiltersParallelMPI-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkFiltersParallelMPI-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkFiltersParallelMPI )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkFiltersParallelMPI "${_IMPORT_PREFIX}/lib/libvtkFiltersParallelMPI-8.2.so.1" )
...
set_target_properties(vtkFiltersParallelStatistics PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkFiltersParallelStatistics-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkFiltersParallelStatistics-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkFiltersParallelStatistics )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkFiltersParallelStatistics "${_IMPORT_PREFIX}/lib/libvtkFiltersParallelStatistics-8.2.so.1" )
...
set_target_properties(vtkIOMPIImage PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkIOMPIImage-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkIOMPIImage-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkIOMPIImage )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkIOMPIImage "${_IMPORT_PREFIX}/lib/libvtkIOMPIImage-8.2.so.1" )
...
set_target_properties(vtkIOMPIParallel PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkIOMPIParallel-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkIOMPIParallel-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkIOMPIParallel )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkIOMPIParallel "${_IMPORT_PREFIX}/lib/libvtkIOMPIParallel-8.2.so.1" )
...
# Import target "vtkInfovisBoostGraphAlgorithms" for configuration "Debug"
set_property(TARGET vtkInfovisBoostGraphAlgorithms APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(vtkInfovisBoostGraphAlgorithms PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "vtkFiltersExtraction;vtkInfovisCore"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkInfovisBoostGraphAlgorithms-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkInfovisBoostGraphAlgorithms-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkInfovisBoostGraphAlgorithms )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkInfovisBoostGraphAlgorithms "${_IMPORT_PREFIX}/lib/libvtkInfovisBoostGraphAlgorithms-8.2.so.1" )
...
set_target_properties(vtkRenderingExternal PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "vtkCommonMath;vtkCommonTransforms"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkRenderingExternal-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkRenderingExternal-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkRenderingExternal )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkRenderingExternal "${_IMPORT_PREFIX}/lib/libvtkRenderingExternal-8.2.so.1" )
...
set_target_properties(vtkRenderingParallel PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkRenderingParallel-8.2.so.1"
  IMPORTED_SONAME_DEBUG "libvtkRenderingParallel-8.2.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkRenderingParallel )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkRenderingParallel "${_IMPORT_PREFIX}/lib/libvtkRenderingParallel-8.2.so.1" )
...
set_target_properties(vtkEncodeString PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkEncodeString-8.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkEncodeString )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkEncodeString "${_IMPORT_PREFIX}/bin/vtkEncodeString-8.2" )
