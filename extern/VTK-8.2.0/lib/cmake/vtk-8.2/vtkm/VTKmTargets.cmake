...
foreach(_expectedTarget vtkm_vectorization_flags vtkm_compiler_flags vtkm_developer_flags vtkm_diy vtkm_taotuple vtkm_loguru vtkm_cont)
...
set_target_properties(vtkm_vectorization_flags PROPERTIES
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:-mavx>"
)
...
set_target_properties(vtkm_developer_flags PROPERTIES
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:-Wall;-Wno-long-long;-Wcast-align;-Wconversion;-Wchar-subscripts;-Wextra;-Wpointer-arith;-Wformat;-Wformat-security;-Wshadow;-Wunused-parameter;-fno-common;-Wno-strict-overflow>"
)
...
set_target_properties(vtkm_diy PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/vtk-8.2/vtkm/thirdparty/diy"
)
...
set_target_properties(vtkm_taotuple PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_auto_type"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/vtk-8.2/vtkm/thirdparty/taotuple"
)
...
set_target_properties(vtkm_loguru PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_auto_type"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/vtk-8.2/vtkm/thirdparty/loguru"
)
...
set_target_properties(vtkm_cont PROPERTIES
  INTERFACE_LINK_LIBRARIES "vtkm_compiler_flags;vtkm::tbb;vtkm::openmp;vtkm_diy;vtkm_taotuple"
)
