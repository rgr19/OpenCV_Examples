...
set(_vtk_installed_prefix "/home/a/W/W.priv/Shared/VTK-8.2.0/lib/cmake/vtk-8.2")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "/home/a/W/W.priv/Shared/VTK-8.2.0")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/home/a/W/W.priv/Shared/VTK-8.2.0/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/home/a/W/W.priv/Shared/VTK-8.2.0/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/home/a/W/W.priv/Shared/src/VTK/cmake-build/VTK-8.2.0/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/home/a/W/W.priv/Shared/src/VTK/cmake-build/VTK-8.2.0/lib")
  endif ()
endif()
...
if(VTK_HAS_VTKM AND NOT TARGET vtkm_cont)
  ...
  if(NOT __vtk_install_tree)
    set(VTKM_CMAKE_DIR "/home/a/W/W.priv/Shared/src/VTK/cmake-build/VTK-8.2.0/ThirdParty/vtkm/vtk-m/lib/cmake/vtk-8.2/vtkm")
  endif()
